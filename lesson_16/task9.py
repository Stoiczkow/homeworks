...
{"name": "Kasia", "email": "k.nowak@example.com", "city": "Warszawa"}

# 1. PATCH

{"name": "Kasia"}

# Metoda PUT modyfikuje cały zasób, natomiast PATCH służy do modyfikacji części zasobu.
# Efektywniej jest używać PATCH.