'''
    Zadanie 8 - Symulacja Klient-Serwer: 
    ...
    Jeśli metoda to GET a cel to /users, powinna zwrócić słownik-odpowiedź
    z kodem 200 i listą użytkowników w ciele.
...
class FakeServer:
    ...
    def handle_request(self, request: dict) -> dict:
        ...
        if method == "POST" and target == "/users":
            ...
            return {
                "status": 201,
                "body": {"message": "User created", "user": new_user}
            }
