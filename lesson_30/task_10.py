...
# Napisz program, który liczy łączną liczbę wystąpień danego słowa we wszystkich plikach .txt w bieżącym katalogu. Każdy plik powinien być przeszukiwany w osobnym wątku. Wyniki zliczania z każdego wątku powinny być bezpiecznie dodane do wspólnego licznika.
