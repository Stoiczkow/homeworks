# 4. Stwórz dwie korutyny: zadanie1 śpi przez 2 sekundy i drukuje "Zadanie 1 zakończone", a
...
# 5. Zmodyfikuj kod z poprzedniego zadania. Uruchom obie korutyny współbieżnie, używając
