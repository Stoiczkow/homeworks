...
from products.views import ProductsViewSet, setname, helloview, NoteViewSet, AuthorViewSet, BookViewSet, calc_view
...
urlpatterns = [
    ...
    path('api/places/delete/<int:id>/', PlaceDeleteApiView.as_view()),
    path('api/longquery', complex_view),
    path("__debug__/", include("debug_toolbar.urls")),
    path("api/schema/", SpectacularAPIView.as_view(), name="schema"),

    path("api/calculate/", calc_view),
